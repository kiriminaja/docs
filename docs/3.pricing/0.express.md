---
title: Get Pricing Express
description: Get a list of available shipping costs and services along with the fees for each service that you can integrate into your system
endpoint:
  method: POST
  url: /api/mitra/v6.1/shipping_price
---
...
| `courier`                 | array    | `true`   | To get the list of couriers, please contact us                                                                                                                     |
...
{
  "origin": 5783,
  "subdistrict_origin": 31532,
  "destination": 5507,
  "subdistrict_destination": 65005,
  "weight": 322,
  "length": 1,
  "width": 1,
  "height": 1,
...
```json
{
  ...
  "text": "Success",
  "details": {
    "origin_district_id": 5783,
    "origin_subdistrict_id": 31532,
    "destination_district_id": 5507,
    "destination_subdistrict_id": 65005,
    "origin_latitude": 0,
    "origin_longitude": 0,
    "weight": 322,
    "item_value": "149990",
    ...
    "origin": 5783,
    "destination": 5507,
    "origin_kelurahan": 31532,
    "destination_kelurahan": 65005,
    "courier": ["jne"]
  },
  "results": [
    {
    ...
    {
      "service": "jne",
      "service_name": "JNE Express Flat",
      "service_type": "FLREG23",
      "cost": "10500",
      "etd": "2-3",
      "cod": true,
      "group": "regular",
