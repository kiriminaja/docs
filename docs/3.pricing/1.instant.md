---
title: Get Pricing Instant
description: API pricing for instant delivery services is flexible and scalable, with a tiered structure based on the volume of requests or deliveries
endpoint:
  method: POST
  url: /api/mitra/v4/instant/pricing
---
