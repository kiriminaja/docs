---
title: Webhook Payload Instant
description: Webhook payloads sent for instant delivery events — shipping, cancellation, and delivery completion
---

:::info
If our webhook endpoint is unavailable, use the [Instant Tracking API](/docs/order/tracking-instant) to pull shipment status directly. This ensures you stay updated even during outages.
:::
