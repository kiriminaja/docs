---
title: Create Order Express v6.1
description: The endpoint you can use to request the creation of an order, either for pickup or drop-off, through KiriminAja
endpoint:
  method: POST
  url: /api/mitra/v6.1/request_pickup
---

:::warning
**Disclaimer**: This API is deprecated. Please use the new [Create Order Express v6.2](../order/1.express.md) API for the latest features and improvements.
:::
...
| `schedule`      | string                 | `false`  | Your parcel ready estimation time. See [Schedule](../pickup/1.schedule.md). Fill with any time if your all parcel is drop-off |
