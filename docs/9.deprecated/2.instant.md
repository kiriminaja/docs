---
title: Create Order Instant v4
description: Request an instant delivery pickup and receive an AWB number for the courier
endpoint:
  method: POST
  url: /api/mitra/v4/instant/pickup/request
---

:::warning
**Disclaimer**: This API is deprecated. Please use the new [Create Order Instant v5](../order/3.instant.md) API for the latest features and improvements.
:::
