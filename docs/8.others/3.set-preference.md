---
title: Set Courier Preference
description: This API is talking about how we show your 3pl preference on api, less to open then less response time
endpoint:
  method: POST
  url: /api/mitra/v3/set_whitelist_services
---
