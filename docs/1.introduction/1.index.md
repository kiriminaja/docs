---
title: Overview
description: KiriminAja Mitra API lets you integrate shipping workflows — check rates, create orders, request pickups, and track deliveries — into your platform with a single REST API
---
...
1. Install Postman. See [Installing and Updating Postman](https://learning.postman.com/docs/getting-started/installation-and-updates/).
...
4. Get your KiriminAja API Key (see [How to Get KiriminAja API Key](#how-to-get-kiriminaja-api-key)).
5. Set `api_key` in the Postman collection with the API key from Sandbox Dashboard.

## How to Get KiriminAja API Key

1. Register for a Sandbox account at the [Sandbox Dashboard](https://sandbox.kiriminaja.com/).
2. Complete the registration process.
3. Log in to [Sandbox Dashboard](https://sandbox.kiriminaja.com/login).
...
For supported versions, installation guides, and latest releases, see [SDK Availability](/docs/others/sdk-availability).
