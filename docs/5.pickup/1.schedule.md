...
description: We provide two shipping methods, namely pickup and drop-off. If you are interested in using our pickup service, then read this documentation for a good implementation
endpoint:
  method: POST
  url: /api/mitra/v2/schedules
---
