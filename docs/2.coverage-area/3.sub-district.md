---
title: Sub District
description: The sub districts that we are open to all expeditions, pick-up and cashless support will change frequently. We will try to follow up with you
endpoint:
  method: POST
  url: /api/mitra/kelurahan
---
