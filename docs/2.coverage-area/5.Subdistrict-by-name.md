---
title: Search Address By Sub District
description: List of districts with direct search by Subdistrict name. We limit requests using throttle limitation, if it is too close then the system will suspend your API call temporarily
endpoint:
  method: GET
  url: /api/mitra/v6.1/addresses
---
