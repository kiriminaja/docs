---
title: Subdistrict by Keyword
description: Search for subdistricts by name keyword or postal code. Requests are rate-limited — excessive calls will temporarily suspend your API access
endpoint:
  method: GET
