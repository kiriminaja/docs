---
title: Tracking Order Express
description: Tracking information is obtained from KiriminAja and the courier service, then consolidated into one dataset
endpoint:
  method: POST
  url: /api/mitra/tracking
---
