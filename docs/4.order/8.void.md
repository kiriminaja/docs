---
title: Cancel Order Express
description: Cancellation of packages that are in the process of waiting for pickup or awaiting delivery
endpoint:
  method: POST
  url: /api/mitra/v3/cancel_shipment
---
