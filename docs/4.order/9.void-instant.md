---
title: Cancel Order Instant
description: Cancel an instant delivery shipment that has not yet been picked up
endpoint:
  method: DELETE
  url: /api/mitra/v4/instant/pickup/void/{order_id}
---

## Request Example

```bash
curl --location --request DELETE 'https://tdev.kiriminaja.com/api/mitra/v4/instant/pickup/void/NBL2-1705636897084' \
